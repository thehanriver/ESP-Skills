...
////////////////////////////////////////////////////////////////////////////////
uint16_t ASCIItoNum(uint8_t numb){
  return (alphafonttable[numb]);
}
static void test_alpha_display() {
 ...
 esp_vfs_dev_uart_use_driver(UART_NUM_0);
    ...
    displaybuffer[0] = 0b1111111111111111; //Open
    displaybuffer[1] = 0b1111111111111111;
    displaybuffer[2] = 0b1111111111111111;
    displaybuffer[3] = 0b1111111111111111;

    // Continually writes the same command
    while (1) {
      char hello[5];
      int hold = strlen(hello);
      printf("Enter a 4 letter: ");
      gets(hello);
      printf("\nsize of string: %d\n", hold);
      if(hold <= 4){
        if(hold == 4){
        for(int i = 0; i < 4; i++){
            displaybuffer[i] = ASCIItoNum(hello[i]);}
        }
        if(hold == 3){
        ...
        if(hold == 1){
          ...
          displaybuffer[1] = ASCIItoNum(hello[0]);
        }
      ...
      displaybuffer[0] = 0b0000000000000000; //Open
      displaybuffer[1] = 0b0000000000000000; //Open
      displaybuffer[2] = 0b0000000000000000; //Open
      displaybuffer[3] = 0b0000000000000000; //Open
