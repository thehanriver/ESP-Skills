...
static void test_alpha_display() {
    ...
    while (1) {
      displaybuffer[0] = alphafonttable[(voltz)/1000%10];
      displaybuffer[1] = alphafonttable[(voltz)/100%10];
      displaybuffer[2] = alphafonttable[(voltz)/10%10];
      displaybuffer[3] = alphafonttable[(voltz)%10];
